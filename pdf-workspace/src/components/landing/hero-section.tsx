            ...
            <div className="flex h-[420px]">
              ...
              <div className="w-20 bg-muted/30 border-r border-border flex flex-col items-center py-3 gap-2">
                {[1, 2, 3].map((p) => (
                  <div
                    key={p}
                    className={`w-14 h-18 rounded border text-center flex flex-col items-center justify-center text-xs gap-1 cursor-pointer transition-all ${
                      p === 1
                  ...
                  >
                    <div
                      className={`w-8 h-10 rounded-sm ${p === 1 ? "bg-ink-100 dark:bg-ink-900" : "bg-muted"}`}
                    />
                    <span>{p}</span>
                  </div>
                ))}
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex-1 bg-muted/20 flex items-center justify-center relative overflow-hidden">
                  <div className="w-64 h-80 bg-white rounded shadow-lg relative flex flex-col items-center justify-center gap-3 border border-border">
                    ...
                    <div className="absolute bottom-8 left-8 right-8 border-b border-gray-300 flex items-end">
                      <span className="text-xs text-muted-foreground italic font-serif pb-1">
                        Signature here...
                      </span>
                    </div>
                  </div>
